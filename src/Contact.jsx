...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert(`Your name is ${data.fullname}. and your Contact number is ${data.phone}, Your response is Submitted `);
    };
                    ...
                    <div className="col-md-6 col-10 mx-auto">
                        ...
                        <form onSubmit={formSubmit}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="mess " value={data.mess} onChange={InputEvent} rows="3"></textarea>
                            </div>
                            <div class="col-12">
